...
namespace CoordinateConversionUtility
{
    ...
    public class CoordinateConverter
    {
        ...
        private DDMCoordinate DecimalDegreesMinutesCoordinate { get; set; } = (DDMCoordinate)default;
        ...
        protected StringBuilder Gridsquare { get; private set; }      // six-character representation of a validated Gridsquare coordinate

        protected decimal LatDirection { get; private set; }   // 1 or -1: represents N or S, respectively
        protected decimal LonDirection { get; private set; }   // 1 or -1: represents E or W, respectively
        ...
        public CoordinateConverter()
        {
            ...
            DecimalDegreesMinutesCoordinate = new DDMCoordinate();
        ...
        /// <summary>
        /// Takes a 6-character string, verifies the formatting, and sets DDM Lattitude & Longitude based on table lookups.
        /// </summary>
        ...
        {   //  TODO: Fix Lat result might be off by <1 degree
            ...
            {
                Gridsquare = new StringBuilder(validGridsquare);
                GetLatDegrees();
            ...
            DecimalDegreesMinutesCoordinate = new DDMCoordinate(
                DDMlatDegrees * LatDirection, DDMlatMinutes, 
                DDMlonDegrees * LonDirection, DDMlonMinutes);
            return DecimalDegreesMinutesCoordinate.ToString();
        }
